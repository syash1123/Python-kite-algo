...
class KiteApp:
    ...
    #         if params[k] is None:
    #             del params[k]
    #     response = self.session.post(f"{self.root_url}/orders/{variety}", data=params, headers=self.headers)
    #     try:
...
# orders
    ...
    def _post(self, param, url_args, params):
        pass
