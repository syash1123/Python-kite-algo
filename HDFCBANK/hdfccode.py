...
# Check if the file has each line as a JSON object or an array of JSON objects
with open(file_path, 'r') as file:
    ...
    if first_char == '[':
        ...
        # The file contains JSON objects per line
        orders = [json.loads(line) for line in file if line.strip()]  # also handling blank lines
