...
# Function to place buy call order
...
#Functin to place Buy order for FUTURE .
def place_buy_fut_order(expiry_month):
    tradingsymbol = f"NFO:RELIANCE24{expiry_month.upper()}FUT"
    print(f"Placing buy order for 1 lot of future : {tradingsymbol}")
    ...
    try:
        ...
        if 'last_price' in ltp_data and ltp_data['last_price'] is not None:
            ...
            print(f"Successfully placed market  order for 1 lot of Reliance at market price: {market_price}")
        else:
            print("Error: 'last_price' not found in market data")
    except Exception as e:
        print(f"Error placing sell order: {e}")
...
def square_off_sell_put_order(strike_price, expiry_month):
    tradingsymbol = f"NFO:RELIANCE24{expiry_month.upper()}{strike_price}PE"
    print(f"Squaring off sell order for 1 put option of Reliance: {tradingsymbol}")
    ...
    try:
        ...
        if 'last_price' in ltp_data and ltp_data['last_price'] is not None:
            ...
            print(f"Successfully Squared off the  limit sell order for 1 put option of Reliance at market price: {market_price}")
        else:
            print("Error: 'last_price' not found in market data")
    except Exception as e:
        print(f"Error placing sell order: {e}")

#Function to square off buy call order
def square_off_buy_call_order(strike_price, expiry_month):
    tradingsymbol = f"NFO:RELIANCE24{expiry_month.upper()}{strike_price}CE"
    print(f"Squaring off  buy order for 1 call option of Reliance: {tradingsymbol}")
    ...
    try:
        ...
        if 'last_price' in ltp_data and ltp_data['last_price'] is not None:
            ...
            print(f"Successfully squared off  limit sell order for 1 put option of Reliance at market price: {market_price}")
        else:
            print("Error: 'last_price' not found in market data")
    except Exception as e:
        print(f"Error placing sell order: {e}")
...
while True:
    ...
    if reliance_five_day_ema > reliance_thirteen_day_ema and reliance_five_day_ema > reliance_twenty_one_day_ema and \
        ...
        # Place a buy order for the Reliance future of current month
        place_buy_fut_order(expiry_month=current_month_name)
        print(f"Buy order placed for 1 Future lot of Reliance  for current month expiry.")
...
while True:
    ...
    if reliance_new_price <= reliance_thirteen_day_ema:
        ...
        square_off_sell_put_order(atm_strike,current_month_name)
        ...
        square_off_buy_call_order(atm_strike,current_month_name)
